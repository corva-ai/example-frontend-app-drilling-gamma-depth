...
var ReactEditor = {
  ...
  toSlatePoint(editor, domPoint, extractMatch) {
    var [nearestNode, nearestOffset] = extractMatch ? domPoint : normalizeDOMPoint(domPoint);
...
export { DefaultElement, DefaultLeaf, DefaultPlaceholder, Editable, ReactEditor, Slate, useEditor, useFocused, useReadOnly, useSelected, useSlate, useSlateStatic, withReact };
